...
final class Finance_Dokan_Preferred_Withdrawal_Methods {
     ...
     * @return array
     */
    public function ensure_custom_methods_in_active_list( $methods, $user_id = 0 ) {
        if ( ! is_array( $methods ) ) {
            return $methods;
        }
    ...
    public function ensure_mpesa_in_vendor_payment_methods( $methods, $seller_id = 0 ) {
        ...
        if ( isset( $custom_methods['mpesa'] ) && empty( $methods['mpesa'] ) ) {
            $methods['mpesa'] = [
                ...
                'method_title'   => $custom_methods['mpesa']['label'],
                'label'          => $custom_methods['mpesa']['label'],
